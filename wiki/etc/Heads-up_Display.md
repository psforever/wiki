...
[squad](../terminology/Squad.md). Red sections indicate a squad member's
...
weaponry; i.e. [Lightning](../vehicles/Lightning.md) weapon systems and BFR
arms.
...
fire](Cone_of_fire.md) system, and how accurate the shot will
...
Used with the [Continental Map](Continental_Map.md), this 'kill
...
[LLUs](../terminology/Lattice_Logic_Unit.md), implant activations and any other system
messages.
...
The presence of an [Amp Station](../locations/Amp_Station.md) allows a shield
...
For [ANT](../vehicles/Advanced_Nanite_Transport.md)'s, there is an [NTU](../items/NTU.md) bar at
the bottom which displays how many [NTU](../items/NTU.md)'s have been
stored from a warpgate to be transferred to an [NTU
Silo](../locations/NTU_Silo.md).

In the case of [BattleFrame Robotics](../vehicles/BattleFrame_Robotics.md),
the vehicle outline also displays the current state of the various BFR
subsystems, as green, yellow and red icons.

[Afterburner](../terminology/Afterburner.md) status, and vehicle speed are
...
- BEP: How many [Battle Experience
  Points](../terminology/Battle_Experience_Points.md) earned this session
- CEP: How many [Command Experience
  Points](../terminology/Command_Experience_Points.md) earned this session.
- SEP: How many [Support Experience
  Points](../terminology/Support_Experience_Points.md) earned this session.
...
This window also shows Frames Per Second (FPS), an indication of how
...
Map](Continental_Map.md), centered on the soldier's current
location.
...
Senior [Outfit](../terminology/Outfit.md) members may edit outfit settings
here.
...
[Health](../terminology/Health.md), [Stamina](../terminology/Stamina.md) and Armor
...
be used to trigger [implants](../implants/Implants.md) (such as the
...
[backpack](../terminology/Backpack.md), available for reload.
...
Engine](../weapons/Adaptive_Construction_Engine.md) shows the object it is
