...
then, including [Core Combat](Core_Combat.md) and [The
...
the planet of [Auraxis](Auraxis.md). Several expeditions were
...
Ranks](Command_Rank.md), which give the players different
...
Combat](Core_Combat.md) was released. This expansion pack added
...
[Solsar](Solsar.md) and [Forseral](Forseral.md), were
...
[shield](Shield_Module.md), [speed](Speed_Module.md),
...
Technology](Ancient_Technology.md) equipment. Also, many people
...
Combat](Core_Combat.md). However, Aftershock marked the
introduction of a new gameplay element, [BattleFrame
Robotics](BattleFrame_Robotics.md) (BFR's).

## See Also

- [Core Combat](Core_Combat.md)
- [Events](Events.md)
- [Patches](Patches.md)
