...
grid references of the members of your current [squad](Squad.md).
...
[Cone of fire](Cone_of_fire.md) system, and how accurate the shot
...
### Status & [Chat](../chat/In-Game_Chat.md) Pane
...
[experience](Experience_Points.md) awards, as they happen, and
world messages, such as the capture of facilities, and the movement of
[LLUs](Lattice_Logic_Unit.md), implant activations and any other
system messages.
...
(See also: [In-Game Commands](../chat/In-Game_Commands.md))
...
[Afterburner](Afterburner.md) status, and vehicle speed are found
...
- BEP: How many
  [Battle Experience Points](Battle_Experience_Points.md) earned
  this session
- CEP: How many
...
Other tabs on this window allow [Friends List](../chat/Friends_List.md)
...
Senior [Outfit](Outfit.md) members may edit outfit settings here.
...
[Health](Health.md), [Stamina](Stamina.md) and
...
trigger [implants](../implants/index.md) (such as the
...
rounds being carried in the [backpack](Backpack.md), available
for reload.
