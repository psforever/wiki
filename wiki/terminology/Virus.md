...
deployables by the [T-REK](../weapons/T-REK.md). A Virus can be removed
from an object by an [expert hacker](../certifications/Expert_Hacking.md) using a
...
[Main Terminal](../items/Main_Terminal.md). The possible viruses for the
...
- Access all enemy [equipment
  terminals](../items/Equipment_Terminal.md) - **2 minutes**
...
Map](../etc/Continental_Map.md), where it will show the type of virus
...
[generator](../items/Generator.md) is destroyed at a base with an active
...
- Enemy [Aegis Shield Generators](../weapons/Aegis_Shield_Generator.md)
