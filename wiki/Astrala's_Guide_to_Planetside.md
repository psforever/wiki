...
[Experience Points](Experience_Points.md) (BEP). BEP is awarded
for kills that you or your squad members achieve. Also you get BEP for
taking over an enemy base. Your [Battle Rank](Battle_Rank.md)
...
your [Certification points](Certification_points.md) (CP).
...
Get [Air Cavalry Scout](Air_Cavalry_Scout.md) (3 CP) if you want
to become a combat pilot. You may even add an extra [Air Cavalry
Assault](Air_Cavalry_Assault.md) (2 more CP) to get access to
the [Reaver](Reaver.md) aircraft which is equipped with powerful
air to ground missiles.

#### Want to fix broken stuff?

Also get [Engineering](Engineering.md) (3 CP) if you want to be
...
[Heavy](Heavy_Assault.md) or [Special
Assault](Special_Assault.md), [Sniping](Sniping.md) or
[Anti-Vehicular](Anti-Vehicular.md). With only Medium assault
and the standard "[Agile Exo-Suit](Agile_Exo-Suit.md)" you are
...
Republic](Terran_Republic.md)'s [Burster](Burster.md)
...
Suit](Infiltration_Suit.md) certificate (2 CP). Also get the
[Engineering](Engineering.md) (3 CP) and [Combat
Engineering](Combat_Engineering.md) (2 extra CP) skill. This
...
- Do not shoot friendly troops. Doing so incurs [Grief
  points](Grief_points.md). Above 1000 grief points, your
...
### [Burster](Burster.md) MAX Tactics
