This version (released March 16, 2006) introduces a large number of UI
and help system improvements, primarily in preparation of an influx of
new players from the [PlanetSide
Reserves](PlanetSide_Reserves.md "wikilink") program.
...
- Players can create characters from all three
  [empires](empire.md "wikilink") now.
- Added an optional free [certification](certification.md "wikilink")
...
- Increased the capacity of the [Burster](Burster.md "wikilink") ammo box
  from 50 to 100
- Increased the velocity of the [Burster](Burster.md "wikilink")
...
- Decreased the refire time of the [Burster](Burster.md "wikilink") while
  unlocked
- Increased the initial velocity of the [Sparrow](Sparrow.md "wikilink")
  projectile
- Reduced the lifespan of the [Sparrow](Sparrow.md "wikilink") projectile
  ...
  ceiling)
- Created new [certification](certification.md "wikilink") for the
...
- Added [BR24+](Battle_Rank.md "wikilink") hats and berets. Characters of
  all three [empires](empire.md "wikilink") gain the option to wear a hat
...
- Confirmation dialogs have been added for the /outfitkick and
  /outfitleave [chat commands](In-Game_Commands.md "wikilink").
- Made it so it is possible to skip through the Bending and
  [BFR](BFR.md "wikilink") movies by hitting any key.
- Added more signs to make Training in
  [sanctuary](sanctuary.md "wikilink") more noticeable
...
- Fixed a bug that allowed [TR](TR.md "wikilink") [MAXes](MAX.md "wikilink")
  to unload full clips by reloading right after anchoring
- Made it so jumping cancels all recalls and rematrixes.
- Fixed a minor bug where destroyed [Router](Router.md "wikilink")
...
- Scrollbar in [empire](empire.md "wikilink") description on the
  character creation screen now shows only if needed
- Improved the W graphic on the proximity radar window
- [Platoon](Platoon.md "wikilink") default chat color is now bright
...
- Changed the new character default
  [certifications](certification.md "wikilink") to have
  [ATV](ATV.md "wikilink") and [Harasser](Harasser.md "wikilink") instead of
  [Armored Assault I](Armored_Assault_I.md "wikilink"). This was to avoid
...
- Slight increase in default size of the radar window to better align
  with other windows
- Added pop up helps for using [weapons](weapon.md "wikilink") and
...
- Changed the [Boomer](ACE.md#Boomer "wikilink") icon to be easier to
  tell from the [HE Mine](ACE.md#Mine "wikilink") icon
- Added tooltips to icons on the CE Window
- Changed order of icons in the CE Window to mirror
  [ACE](ACE.md "wikilink") fire mode selection order
- Revised the [Certification](Certification.md "wikilink") training
...
- [Mosquito](Mosquito.md "wikilink") radar icon should not disappear
  after traveling through a [warpgate](warpgate.md "wikilink").
- Removed tooltips from the Create Character screen face grid and the
  Select Outfit Decal dialog.
- All flak projectiles ([Burster](Burster.md "wikilink"),
  [BFR](BFR.md "wikilink") Burster, [Skyguard](Skyguard.md "wikilink"), and
  [Flaklet](Rocklet_Rifle.md "wikilink")) now detonate upon impacting
...
- [Outfit](Outfit.md "wikilink") Info → Outfit
- [Vehicle](Vehicle.md "wikilink") Access → Vehicle
...
- Changed server names from Markov (and Johari) and Emerald (and
  Konried) to just [Markov](Markov.md "wikilink") and
  [Emerald](Emerald.md "wikilink").
- Disabled first-time help for [sanctuary](sanctuary.md "wikilink")
  (obsolete now)
...
- Hooked in timed help triggers for the following events:
  - First [Infiltration Suit](Infiltration_Suit.md "wikilink")
  - First [MAX](MAX.md "wikilink") suit (different help for each
    empires)
  ...
  - First acquire of vehicles with special actions
    ([AMS](AMS.md "wikilink"), [ANT](ANT.md "wikilink"),
    [Flail](Flail.md "wikilink"), [Router](Router.md "wikilink"),
    [Switchblade](Switchblade.md "wikilink"))
...
- Removed nVidia and redundant [PlanetSide](PlanetSide.md "wikilink")
  Logo splash screens
...
- Changed wording of option to "Show First Time Help" instead of "Show
  Star-Help Training"
- Revised the Map and [MAX](MAX.md "wikilink") and [Infiltration
  Suit](Infiltration_Suit.md "wikilink") training missions.
...
- Fixed bug where equipment terminal and inventory window would appear
  ...
  default UI settings
- Removed the [HUD](HUD.md "wikilink") training mission
...
- [Continent](Continent.md "wikilink") map now re-centers and zooms out
  when map switches to [warpgate](warpgate.md "wikilink") destination or
