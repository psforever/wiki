...
[Amerish](Amerish.md) : Amer
[Battle Islands](Battle_Islands.md) : BI, BI's
[Ceryshen](Ceryshen.md) : Cery
[Cyssor](Cyssor.md) : Cys, [CyssorSide](#CyssorSide)
[Desolation](Oshur.md#Desolation) : Deso
[Esamir](Esamir.md) : Esa
[Forseral](Forseral.md) : Fors, Forsy
...
Bang Buggy : Slang term for the [Terran Republic](Terran_Republic.md) [Marauder](Marauder.md)
Bang Bus : Common term used when referring to a [Sunderer](Sunderer.md) variant troop transport. Also called _Sundy_, _Funbus_, _Mack Truck_, and _Winnebego_.
...
CoF : System used to determine where shots are fired. See [Cone of fire](Cone_of_fire.md)
Cerb / Cerbs : [Cerberus Turrets](Cerberus_Turret.md)
Cert : [Certifications](Certifications.md)
Chair : [One-Manned Field Turret](One-Manned_Field_Turret.md) ("Deploy more Chairs!")
CN : Chinese player
...
CyssorSide : A derogatory term for fighting on [Cyssor](Cyssor.md). Due to the size of the continent and base links, battles usually last a long time (sometimes multiple days) and are often a three way.
...
EAMS : Enemy [AMS](Advanced_Mobile_Station.md). (Specify location if reporting one, e.g., EAMS @ BD.)
Es : [Esamir](Esamir.md).
ESAV : Empire Specific Anti-Vehicular weapons ([Lancer](Lancer.md), [Phoenix](Phoenix.md), and [Striker](Striker.md)).
ESMA : Empire Specific Medium Assault weapons ([Pulsar](Pulsar.md), [Gauss](Gauss.md), and [Cycler](Cycler.md)). Not to be confused with EAMS.
Eterm : [Equipment Terminal](Equipment_Terminal.md).
ENG/Engy : [Engineers](Engineering.md), collectively.
...
Glue : [Armor Canisters](Armor_Canister.md) for armor or vehicular repair. Also the act of repairing. ("I'm going to glue the gen.")
GlueGun : Referring to the [Nano Dispenser](Nano_Dispenser.md)
Granny Hacking : Hacking without the [Hacking](</Hacking_(Certification)>) or [Advanced Hacking](Advanced_Hacking.md) abilities.
...
Imo : "In My Opinion"
Infy, Infil : Cloaked enemy, also refers to the [Infiltration Suit](Infiltration_Suit.md).
Infil Suit : Abbreviation for the [Infiltration Suit](Infiltration_Suit.md)
...
laze : to mark a location with the [Laze Pointer](Laze_Pointer.md).
...
Mono : Short for [Monolith](Monolith.md)
...
omw : On my way.
otw : On the way.
OS : [Orbital Strike](Orbital_Strike.md)

## P

pinvite : [Platoon](Platoon.md) Invite
PJ , PJ's , Pajamas : Refers to the [Standard Exo-Suit](Standard_Exo-Suit.md).
...
present : [High Explosive Mine](High_Explosive_Mine.md) ("I left some presents by the [BD](Back_Door.md).")
PS : [Personal Shield](Personal_Shield.md), [PlanetSide](PlanetSide.md)
...
rgr, Rog : Roger, ok.
rolling coffin : [Sunderer](Sunderer.md).
...
SG : Refers to either the Sturmgrenadier or Serious Gamers outfit, or the [Skyguard](Skyguard.md) Anti-Aircraft Buggy.
Skeets, Skeeter, Mossies : Common referrences to the [Mosquito](Mosquito.md) aircraft.
...
Sundy : [Sunderer](Sunderer.md) variants

## T

Thun/Thundy : [Thunderer](Thunderer.md), the [New Conglomerate](New_Conglomerate.md)-specific advanced [Deliverer](Deliverer.md).
...
VG, Van, Vang, Vanny : [Vanguard](Vanguard.md)
Van00b : Offensive term for the [Vanu Sovereignty](Vanu_Sovereignty.md) - used when one is being attacked by several Vanu Reservists - ie; "Help! I'm being swarmed by Van00bs!"
Vent :[Ventrilo](http://www.Ventrilo.com), voice communication software.
VPad : Vehicle Creation Pad. See also VT.
VT, Vterm : [Vehicle Terminal](Vehicle_Terminal.md)
...
666th : [666th Spec. Ops "Devil Dogs"](666th_Spec.md._Ops_"Devil_Dogs") [Outfit](Outfit.md) ([NC](New_Conglomerate.md))
88s : Crazy 88s Outfit (NC)
AC : Ahriman Corps Outfit ([VS](Vanu_Sovereignty.md))
...
DS : [Dark Skyes](Dark_Skyes.md) (TR)
DT : [Delta Triad](Delta_Triad.md) Outfit (VS)
FC : [Future Crew](Future_Crew.md) Outfit (VS)
HG : Hired Guns Outfit (NC)
Ht : Refers to the Hostile Takeover Outfit (NC)
KOJ: [KEEPERS of JOHARI](KEEPERS_of_JOHARI.md) Outfit (VS)
KOTOR : [Knights of the Old Republic](Knights_of_The_Old_Republic.md) Outfit ([TR](Terran_Republic.md))
OC : outcasters Outfit (TR)
PCP : [Psychedelic Clown Posse](Psychedelic_Clown_Posse.md) Outfit (TR)
PH : Purple Haze Outfit (VS)
SS : Soul_Strike Outfit (VS)
RedX : Better RED than DEAD Outfit (TR)
TRx : [Knights of the Old Republic](Knights_of_The_Old_Republic.md) Outfit (TR)
ULTRA : United League of Terran Republic Alliances (TR)
VC : [Victor Company](Victor_Company.md) Oufit (NC) And [Vanu Corporation](Vanu_Corporation.md) (VS)
