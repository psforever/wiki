...
- [Armored Assault I](Armored_Assault_I.md)
  - [Armored Assault II](Armored_Assault_II.md)
    ...
    - [BattleFrame Robotics](BattleFrame_Robotics.md)
      - [BFR Anti-Infantry](BFR_Anti-Infantry.md)
      - [BFR Anti-Aircraft](BFR_Anti-Aircraft.md)
- [Ground Transport](Ground_Transport.md)
- [Ground Support](Ground_Support.md)
- [Air Cavalry, Scout](Air_Cavalry_Scout.md)
  - [Air Cavalry, Assault](Air_Cavalry_Assault.md) ([Light
    Scout](Light_Scout.md) can be used in place of Air
...
[Vulture](Vulture.md) : [Bomber Ace Bronze](Bomber_Ace.md)
Flight-Variant BFRs ([Invader](Invader.md), [Eclipse](Eclipse.md), or [Eagle](Eagle.md)) : [BFR Basic](<BFR_(Merit)>)

### Vehicle Terminal

![](images/NCmag.jpg "fig:NCmag.jpg") is a vehicle which requires a [Technology
Plant](Technology_Plant.md).\]\] Once a player has the correct
certification, a player can purchase the vehicle from a friendly or
hacked [Vehicle Terminal](Vehicle_Terminal.md). However, some
...
Module](Vehicle_Module.md), in which the timer is reduced to
2:30.

In short, vehicles that are under [Air Cavalry
Scout](Air_Cavalry_Scout.md), [Air Cavalry
Assault](Air_Cavalry_Assault.md), the
...
require a [Technology Plant](Technology_Plant.md) to be able to
...
[Sanctuary](Sanctuary.md) also counts as well. The vehicles that
...
- [Infiltration Suit](Infiltration_Suit.md)
- [Standard Exo-Suit](Standard_Exo-Suit.md)
- [Agile Exo-Suit](Agile_Exo-Suit.md)

Other vehicles have no such restriction, and allow the above armors as
well as a user wearing a [Reinforced
Exo-Suit](Reinforced_Exo-Suit.md) to be the driver. These are
...
Most vehicles in [PlanetSide](PlanetSide.md) are not solo
...
awarded [Experience](Experience.md). Also, a gunner or a
...
- [Ground Gunner](Ground_Gunner.md) (most ground vehicles)
- [Bombardier](<Bombardier_(Merit)>) (Liberator and Vulture)
- [Air Defender](Air_Defender.md) (Skyguard)
- [Cavalry Pilot](Cavalry_Pilot.md) (Galaxy Gunship)
...
Exo-Suit](Reinforced_Exo-Suit.md) may not utilze these spots on
