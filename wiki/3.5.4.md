...
Implemented [Squad Home Base](Squad_Home_Base.md "wikilink") functionality.
...
### [Sanctuary](Sanctuary.md "wikilink") Respawn
...
Leader](Platoon_Leader.md "wikilink") 2) [Squad
Leader](Squad_Leader.md "wikilink") 3) largest group of
[Squad](Squad.md "wikilink") Members 4) largest group of
[Platoon](Platoon.md "wikilink") Members If none of the above apply, the
...
- Sanctuary [HART buildings](HART_building.md "wikilink") are now labeled
  A, B or C for easier reference.
- "Vehicle Stolen!" text will now appear in RED!
- The [Range Magnifier](Range_Magnifier.md "wikilink") Implant is now
  toggle-able
...
- /comsu will now properly do continent all chat for appropriate level
  commanders in Supai
- [Driver Gunnery](Driver_Gunnery.md "wikilink") Platinum will now
  properly count kills
- Fixed a vehicle problem with cargo in [galaxies](Galaxy.md "wikilink")
  or [lodestars](Lodestar.md "wikilink") when deconstructing.
- Fixed an issue that would cause the [Lodestar](Lodestar.md "wikilink")
...
- [Grenades](Weapons_Index.md#Grenades "wikilink") will now auto-reload
  more like other weapons
- Grenades in [Inventory](Inventory.md "wikilink") will now display how
...
- Correcting an issue with alpha and the [Wraith](Wraith.md "wikilink").
...
- Also fixed an issue that would cause an
  [infiltrator](infiltrator.md "wikilink") to decloak and then re-cloak
  when dismounting a [Wraith](Wraith.md "wikilink") that was visible when
  first mounted.
- Addressed an issue that could cause the
  [Radiator](Radiator.md "wikilink") and
  [Maelstrom](Maelstrom.md "wikilink") to not damage enemies.
- [Hacking](</Hacking_(Certification)> "wikilink") and [Advanced
  Hacking](Advanced_Hacking.md "wikilink")
  [certification](certification.md "wikilink") descriptions now more
  accurately reflect those abilities.
- Tower names on the [Battle Islands](Battle_Islands.md "wikilink") now
  reflect the names of [warpgates](warpgate.md "wikilink") they are near.
- Removed an incorrect green strip from the [Weapons Expert
  Citation](Weapons_Citation.md "wikilink")
...
- Improved the server process when [Core
  Combat](Core_Combat.md "wikilink") caverns rotate to remove a
