...
[Magrider](Magrider.md) drivers in planetside, this guide is
...
I consider the [Magrider](Magrider.md) to be the best tank in
planetside. While the [Prowler](Prowler.md) and
[Vanguard](Vanguard.md) are better in specific situations, the
...
[Pulsar](Pulsar.md) to the [Lasher](Lasher.md) because
you can hot swap with the glue gun directly and it saves space. The
[Pulsar](Pulsar.md) also provides medium-range fire that the
...
[Darklight](Darklight.md), and [Audio
Amplifier](Audio_Amplifier.md). Always have Audio Amp on, and
...
need to watch out for [Liberators](Liberator.md) lining you up
...
[Mosquito](Mosquito.md)'s overflight radar data is transmitted
...
- [Lightnings](Lightning.md): Not much of a threat. Usually
...
- [Fury](Fury.md): One of your biggest threats. Second only to
...
- Sunderer Variants ([Vindicator](Vindicator.md),
  [Juggernaut](Juggernaut.md), and
  [Leviathan](Leviathan.md)): Though all very similar in
  ...
  their [EMP](EMP.md) blast. Stay as far away as possible to
  ...
  their EMP.
- [One-Manned Field Turrets](One-Manned_Field_Turret.md): All
...
- [New Conglomerate](New_Conglomerate.md)
  - [Vanguard](Vanguard.md): Probably the easiest enemy tank
  ...
  - [Thunderer](Thunderer.md): I fear this vehicle the most
  ...
  - [Enforcer](Enforcer.md): Usually not much of a threat,
    unless they are in packs. They are fast, however, which makes
    killing them a little tricky.
  - [Phoenix](Phoenix.md): While the Phoenix has a slow rate
    ...
    Phoenix users.
  - [Peregrine](Peregrine.md): If it has the particle cannon
...
- [Terran Republic](Terran_Republic.md)
  - [Prowler](Prowler.md): This is your biggest enemy tank
    threat. At close range, the [Prowler](Prowler.md) will
    kill you in the blink of an eye, especially with 2 gunners. Use
    the same tactics as the [Vanguard](Vanguard.md) above.
    Stay as far away as possible and lure them into trees or head
    for water.
  - [Raider](Raider.md): While not as deadly as the
    [Thunderer](Thunderer.md), at point blank range, you
    will still have a hard time winning. Keep as far away as
    possible, where the damage of the raider is less. Like the
    tactics for the [Thunderer](Thunderer.md), water might
    not always be the right choice.
  - [Marauder](Marauder.md): Very little threat unless you
    ...
    and [Striker](Striker.md) you. Kill them before they can
    bail.
  - [Striker](Striker.md): A lone striker is no threat, but
  ...
  - [Colossus](Colossus.md): Not as bad as the
    [Peregrine](Peregrine.md), but still just as hard to
    kill. Treat like a [Prowler](Prowler.md) to avoid fire.
...
- [Vanu Sovereignty](Vanu_Sovereignty.md)
  ...
  - [Aurora](Aurora.md): Laugh at them after you kill them.
    Not a big threat.
  - [Thresher](Thresher.md): Keep moving to avoid fire.
    Treat like an [Enforcer](Enforcer.md).
  - [Lancer](Lancer.md): Not much you can do to avoid fire.
    Find cover and try to get out of range, though the range is
    huge. Trees might help.
  - [Aphelion](Aphelion.md): If you ever find one of these,
...
and a [Lasher](Lasher.md) if you have it certed, though a
[Pulsar](Pulsar.md) is fine too. You don't need to carry more
...
Targeting](Enhanced_Targeting.md) and
[Darklight](Darklight.md). The third slot is up to you, but
[Audio Amplifier](Audio_Amplifier.md) is probably best.
...
firing at that [Prowler](Prowler.md) a mile away, your driver
might have just run into a [Thunderer](Thunderer.md) at point
...
[Vanguard](Vanguard.md) but a [Reaver](Reaver.md) is
...
- [Reaver](Reaver.md): Probably your biggest threat, so they
...
- Tanks: Low on the list, but they have high firepower if they are
  nearby.
- [Thunderer](Thunderer.md) and [Raider](Raider.md):
...
to check for cloakers, especially near [Lodestars](Lodestar.md).
...
Engineering](Combat_Engineering.md), several new tactics can be
...
[Cerberus Turrets](Cerberus_Turret.md) are also a nice addition
