...
- All mouse mappings should now be shown only when the mouse icon is
  ...
  mappings).
- [Light Scout](../certifications/Light_Scout.md) now counts towards the [Air
  Cavalry Scout](../certifications/Air_Cavalry_Scout.md) prerequisites for 2nd
  tier Air Cavalry [certifications](../certifications/Certification.md).
