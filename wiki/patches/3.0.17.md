...
- While the [Light Scout](../Light_Scout.md) vehicles are now
  ...
  combination.
- The [Striker](../Striker.md) and [MA../MAX.md.md) lock-on
  ...
  ([Skyguard](../Skyguard.md) and [Burster../Burster.md.md))
...
- Increased Buggy and Tank maximum speeds .
  [Prowler](../Prowler.md) - 57 [Vanguar../Vanguard.md.md) -
  ...
  [Router](../Router.md) and [Sundere../Sunderer.md.md).
  ...
  the [TR](../TR.md) [Pounde../Pounder.md.md) and [Dual
  Cycler](../Dual_Cycler.md) [MA../MAX.md.md) armor when
...
- [Vehicles](../Vehicle.md)' access permissions can now be
  ...
  Trunk).
- [Galaxy](../Galaxy.md) and [Lodesta../Lodestar.md.md)
