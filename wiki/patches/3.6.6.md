...
- Added a hotkey to toggle visibility of the squad range glow ring on the
  [Radar](Radar.md) display. (default: Alt-C)

## Fixes

- Corrected an issue that caused the saved favorites to appear greyed out at
  [Repair Silos](Repair_Silo.md) for [BFRs](../vehicles/BattleFrame_Robotics.md)
  and [MBTs](MBT.md) or certain other [Vehicles](../vehicles/Vehicle.md).
...
There will be no [Server](Server.md) downtime required for this update. The
