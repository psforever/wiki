...
wants to further increase his hacking potential with the [REK](../REK.md) or
...
- Steal enemy [field turrets](../OMFT.md) instead of just deconstructing them.
...
- Infect [Wall Turrets](../Wall_Turrets.md) and
  [Spitfires](../weapons/Adaptive_Construction_Engine.md#Spitfire) so they will
...
- Completely masks nearby friendly units from enemy radar, even when detected by
  sensors.
- Can be deployed in any [SOI](../SOI.md), but only outside and not too close to
  a building.
