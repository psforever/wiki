...
- [Boomers](../weapons/Adaptive_Construction_Engine.md#Boomer) placed near
  ...
  [certification terminals](certification_terminal.md) will now do the correct
  amount of damage.
- Boomers placed outside [spawn tubes](spawn_tube.md) will now do the correct
...
- [Empire Benefits](Empire_Benefits.md) window is now resizable
...
- [MAX](../items/Mechanized_Assault_Exo-Suit.md) units should now show on the
  [Interlink Facility](../terminology/Interlink.md) radar all the time, but
