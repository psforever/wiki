...
- Holding certain types and combinations of
  ...
  [Empire Benefits](Empire_Benefits.md).
...
- [Certifications](../certifications/Certification.md) have been reset to
  ...
  - [Light Scout](../certifications/Light_Scout.md) is now a five point
    ...
    [Mosquito](../vehicles/Mosquito.md), [Skyguard](../items/Skyguard.md) and
    Empire Specific
...
- [Repair Silos](Repair_Silo.md) will be able to repair
  [Ancient Tech](../Ancient_Tech.md) [vehicles](../vehicles/Vehicle.md) in
...
- [ACE](../weapons/Adaptive_Construction_Engine.md) Deployables can no longer be
  placed at the end of [Cavern](../Cavern.md) [ziplines](../items/Zipline.md).
...
- [Orbital Strikes](../commands/Orbital_Strike.md) should not be able to affect
  avatars inside of [Towers](../Tower.md).
...
- [Flail](../items/Flail.md) projectiles will appear properly on other clients.
