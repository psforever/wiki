...
- Session stats are displayed on the [HUD](../etc/Heads-up_Display.md) so that
...
- Fixed an issue that would allow [Implants](../implants/Implants.md) to be used
...
- The [Vehicle](../vehicles/Vehicle.md) [HUD](../etc/Heads-up_Display.md) has
