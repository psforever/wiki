...
Reserves](../PlanetSide_Reserves.md) program.
...
- Players can create characters from all three
  [empires](empire.md) now.
- Added an optional free [certification](certification.md)
...
- Increased the capacity of the [Burster](../Burster.md) ammo box
  from 50 to 100
- Increased the velocity of the [Burster](../Burster.md)
...
- Decreased the refire time of the [Burster](../Burster.md) while
  unlocked
- Increased the initial velocity of the [Sparrow](../Sparrow.md)
  projectile
- Reduced the lifespan of the [Sparrow](../Sparrow.md) projectile
  ...
  ceiling)
- Created new [certification](certification.md) for the
...
- Added [BR24+](../Battle_Rank.md) hats and berets. Characters of
  all three [empires](empire.md) gain the option to wear a hat
...
- Confirmation dialogs have been added for the /outfitkick and
  /outfitleave [chat commands](../In-Game_Commands.md).
- Made it so it is possible to skip through the Bending and
  [BFR](../BFR.md) movies by hitting any key.
- Added more signs to make Training in
  [sanctuary](sanctuary.md) more noticeable
...
- Changed the new character default
  [certifications](certification.md) to have
  [ATV](../ATV.md) and [Harasse../Harasser.md.md) instead of
  [Armored Assault I](../Armored_Assault_I.md). This was to avoid
...
- Slight increase in default size of the radar window to better align
  with other windows
- Added pop up helps for using [weapons](weapon.md) and
...
- Changed the [Boomer](../ACE.md#Boomer) icon to be easier to
  tell from the [HE Mine](../ACE.md#Mine) icon
- Added tooltips to icons on the CE Window
- Changed order of icons in the CE Window to mirror
  [ACE](../ACE.md) fire mode selection order
- Revised the [Certification](../Certification.md) training
...
- [Mosquito](../Mosquito.md) radar icon should not disappear
  after traveling through a [warpgate](warpgate.md).
- Removed tooltips from the Create Character screen face grid and the
  Select Outfit Decal dialog.
- All flak projectiles ([Burster](../Burster.md),
  [BFR](../BFR.md) Burster, [Skyguar../Skyguard.md.md), and
  [Flaklet](../Rocklet_Rifle.md)) now detonate upon impacting
...
- [Outfit](../Outfit.md) Info → Outfit
- [Vehicle](../Vehicle.md) Access → Vehicle
...
- Changed server names from Markov (and Johari) and Emerald (and
  Konried) to just [Markov](../Markov.md) and
  [Emerald](../Emerald.md).
- Disabled first-time help for [sanctuary](sanctuary.md)
  (obsolete now)
...
- Hooked in timed help triggers for the following events:
  - First [Infiltration Suit](../Infiltration_Suit.md)
  - First [MAX](../MAX.md) suit (different help for each
    empires)
  ...
  - First acquire of vehicles with special actions
    ([AMS](../AMS.md), [AN../ANT.md.md),
    [Flail](../Flail.md), [Route../Router.md.md),
    [Switchblade](../Switchblade.md))
...
- Removed nVidia and redundant [PlanetSide](../PlanetSide.md)
  Logo splash screens
...
- Changed wording of option to "Show First Time Help" instead of "Show
  Star-Help Training"
- Revised the Map and [MAX](../MAX.md) and [Infiltration
  Suit](../Infiltration_Suit.md) training missions.
...
- [Continent](../Continent.md) map now re-centers and zooms out
  when map switches to [warpgate](warpgate.md) destination or
