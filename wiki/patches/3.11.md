...
- Fixed a bug that allowed [TR](../TR.md) [MAXes](../MAX.md)
...
- Changed the new character default
  ...
  [ATV](../ATV.md) and [Harasser](../Harasser.md) instead of
...
- Made it so reserve ammo does not display for
  [Switchblades](../Switchblade.md), [Flails](../Flail.md),
...
- All flak projectiles ([Burster](../Burster.md),
  [BFR](../BFR.md) Burster, [Skyguard](../Skyguard.md), and
...
- Hooked in timed help triggers for the following events:
  ...
  - First acquire of vehicles with special actions
    ([AMS](../AMS.md), [ANT](../ANT.md),
    [Flail](../Flail.md), [Router](../Router.md),
    [Switchblade](../Switchblade.md))
