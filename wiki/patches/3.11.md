...
- Changed the [Boomer](../weapons/Adaptive_Construction_Engine.md#Boomer) icon
  to be easier to tell from the
  [HE Mine](../weapons/Adaptive_Construction_Engine.md#Mine) icon
...
- Made it so reserve ammo does not display for
  [Switchblades](../items/Switchblade.md), [Flails](../items/Flail.md), and
...
- All flak projectiles ([Burster](../items/Burster.md),
  ...
  [Skyguard](../items/Skyguard.md), and [Flaklet](../weapons/Rocklet_Rifle.md))
