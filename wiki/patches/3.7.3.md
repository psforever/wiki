...
- Fixed a visibility issue with the
  [Infiltration Suit](../items/Infiltration_Suit.md) when changing displayed
  awards.
- Corrected an issue with [Darklight](../implants/Darklight.md)
  [Implant](../Implant.md) that caused unintended problems with the
...
- AA [MAX](../items/Mechanized_Assault_Exo-Suit.md) Units should now be able to
