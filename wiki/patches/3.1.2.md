...
- [Flail](../items/Flail.md) damage has been changed. The flail projectile will
...
- Fixed an issue where if the [BFR](../vehicles/BattleFrame_Robotics.md) servos
  ...
  animations.
- Slightly tightened the [Cone of Fire](../etc/Cone_of_fire.md) of the
...
- The [Punisher](../weapons/Punisher.md) will be able to fire three shots before
  its [Cone of Fire](../etc/Cone_of_fire.md) begins to bloom.
