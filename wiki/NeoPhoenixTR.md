...
Most BFR pilots on Emerald know of my incessant love of "BFR Hunting"
...
Merit](BFR_Buster.md) and have over 850 BFRs kills recorded
...
[KAAOS](KAAOS.md), about our outfit nights and turn it into a
...
[BattleFrame](BattleFrame_Robotics.md) units and destroying
...
Points](Battle_Rank.md), the [BFR Buster
Merit](BFR_Buster.md), and _"fame"_ of being a skilled BFR
Hunter.
...
[certs](Certifications.md) are **required**:

- [Air Cavalry Scout](Air_Cavalry_Scout.md) +
  [Assault](Air_Cavalry_Assault.md)
...
- [Surge](Surge.md)
- [Enhanced Targeting](Enhanced_Targeting.md)
- [Second Wind](Second_Wind.md)
...
hunt. These things are taught in my outfit, [KAAOS](KAAOS.md)'
...
[Reaver](Reaver.md) and [Mosquito](Mosquito.md),
including:
...
This kind of awareness can only be acquired by experience within
...
[Decimator](Decimator.md) by swapping it with another, and is
...
tripleshot [Jackhammer](Jackhammer.md), and even see it as a
...
BFRs](BattleFrame_Robotics.md#The_Variants) take 4-5 decimator
...
aircraft in [Rexo](Reinforced_Exo-Suit.md), and the inventory
space of both the [Infiltrator](Infiltration_Suit.md) and
[Standard Armor](Standard_Exo-Suit.md) is insufficient to carry
your payload.
...
[Heavy Assault](Heavy_Assault.md). This is good for characters
who are at very low [Battle Ranks](Battle_Rank.md) that need to
make some quick [BEP](Battle_Experience_Points.md) by hunting.
...
Shotgun](Sweeper.md) is a good choice for a defensive weapon
from the [Medium Assault](Medium_Assault.md) pool. It
specializes in close-combat, and is common-pool, so the price is right.
The [REK](Remote_Electronics_Kit.md) is totally optional. It's
recommended if you have [Advanced Hacking](Advanced_Hacking.md),
...
An important thing to note in this loadout is the spacing indicated in
...
disadvantage. The TR's [Mini-Chaingun](Mini-Chaingun.md) has a
100 bullet clip that is capable of killing 2-3 grunts before running
dry. The NC's [Jackhammer](Jackhammer.md) is like the Sweeper,
but bigger, specializing in close-combat. The VS'
[Lasher](Lasher.md), however, only has 25 shots, and is at a
...
a [Bolt Driver](Bolt_Driver.md), much like it bypasses the
Decimator refire time.

Another fun way to practice that _does_ let you practice the "third
Deci" is to use an enemy [Generator](Generator.md) as a test
...
You got your loadout, you got your moves, now you just need your target:
Enemy BattleFrames.

### Defensive Flying

The main approach to BFRs, like stated earlier, is [Air
Cavalry](Air_Cavalry_Assault.md). So, let's start with how to
...
But, these aren't the only places. This is where use of "The Force" may
...
<small>Placement under a TR [Colossus](Colossus.md) or
[Invader](Invader.md)</small>
...
<small>Placement under an NC [Peregrine](Peregrine.md) or
[Eagle](Eagle.md)</small>
...
<small>Placement behind a VS [Aphelion](Aphelion.md) or
[Eclipse](Eclipse.md)</small>
...
<small>Where to aim against a TR [Colossus](Colossus.md) or
[Invader](Invader.md)</small>
...
<small>Where to aim against an NC [Peregrine](Peregrine.md) or
[Eagle](Eagle.md)</small>
...
<small>Where to aim against a VS [Aphelion](Aphelion.md) or
[Eclipse](Eclipse.md)</small>
...
- Aphelion
- [Colossus Hitbox Diagram](Media:ColossusHitbox.md.jpg)
  <small>(pictures courtesy of GlenMichael, TR Emerald)</small>
- Eagle
- Eclipse
- [Invader Hitbox Diagram](Media:InvaderHitbox.md.jpg)
