...
Auraxium](Bomber_Ace.md) merit and this is what has worked for
me.
...
Against the [Sparrow](Sparrow.md) MAX, you need to fly a little
...
Against a [Striker](Striker.md) or
[Starfire](Starfire.md) you can either find a tree or terrain to
...
Against a [Wasp](Wasp.md) and you are flying low, fly through
trees as much as possible to break the lock. Flying inside an [Aegis
Shield Generator](Aegis_Shield_Generator.md) will also break the
...
The tactics with the [Vulture](Vulture.md) is almost identical
