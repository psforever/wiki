...
[Grid](Grid.md) reference is shown under their name.

In a [Platoon](Platoon.md), this information extends to cover up
to two other squads, show in different colored borders; yellow, orange,
and purple.

### [Proximity Map](Proximity_Map.md)

Located at the top left, the [Proximity Map](Proximity_Map.md)
...
weaponry; i.e. [Lightning](Lightning.md) weapon systems and BFR
arms.
...
### Status & [Chat](In-Game_Chat.md) Pane
...
(See also: [In-Game Commands](In-Game_Commands.md))

Both section are scrollable and retain several hundred lines.

The top bar of this window has buttons to allow [LFS](LFS.md)
...
The presence of an [Amp Station](Amp_Station.md) allows a shield
...
In the case of [BattleFrame Robotics](BattleFrame_Robotics.md),
the vehicle outline also displays the current state of the various BFR
subsystems, as green, yellow and red icons.

[Afterburner](Afterburner.md) status, and vehicle speed are
...
- K/D: How many kills the soldier has made and how many time he has
  died, this session.
- A: How many Kill [Assists](Assist.md) you have made.
- BEP: How many [Battle Experience
  Points](Battle_Experience_Points.md) earned this session
- CEP: How many [Command Experience
  Points](Command_Experience_Points.md) earned this session.
- SEP: How many [Support Experience
  Points](Support_Experience_Points.md) earned this session.
...
[Inventory](Inventory.md); pistol and rifle slots, and backpack.
...
Other tabs on this window allow [Friends List](Friends_List.md)
management and, [Ignore List](Ignore.md) management.
...
Senior [Outfit](Outfit.md) members may edit outfit settings
here.
...
[Health](Health.md), [Stamina](Stamina.md) and Armor
...
Engine](Adaptive_Construction_Engine.md) shows the object it is
