...
The NTU Siphon has two modes. The first draws [NTUs](../NTU.md) from active
...
[BEP](BEP.md) for filling friendly silos. For every 2 NTUs you siphon, only 1
...
EMP is expelled (identical to one called by a [CUD](CUD.md)). An EMP can only be
